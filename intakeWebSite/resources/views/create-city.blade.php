    ...
    <div class="modal-content">
      <form action="/create-city" method="POST">
        ...
        <div class="form-group">
          ...
          <input required name="name" id="city-name" class="form-control" type="text" placeholder="" autocomplete="off" />
          @error('name')
        ...
        <div class="form-group">
            <label for="city-code">Postal Code</label>
            <input required name="postalcode" id="city-code" class="form-control" type="text" placeholder="" autocomplete="off" />
            @error('postalcode')
            <p class="m-0 small alert alert-danger shadow-sm">{{$message}}</p>
            @enderror
          </div>
