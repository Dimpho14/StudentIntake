...
<x-layout>
    ...
    <div class="table-wrapper">
      ...
      <div class="row">
      <div class="col-sm-6">
      <h2>Manage <b>Room Type</b></h2>
      </div>
      <div class="col-sm-6">
      <a href="#addEmployeeModal" class="btn btn-success" data-toggle="modal"><i class="material-icons">&#xE147;</i> <span>Add Room Type</span></a>
      ...
      <form action="/create-type" method="POST">
        ...
        <div class="modal-body">
          <div class="form-group">
            <label for="building-name" class="text-muted mb-1"><small>Room Type</small></label>
            <input value="{{old('name')}}" name="name" id="building-name" class="form-control" type="text" placeholder="Type room type" autocomplete="off" />
            @error('name')
